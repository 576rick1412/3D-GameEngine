...
Matrix44 Matrix44::Multiply(Matrix44 mat_1, Matrix44 mat_2, Matrix44 mat_3, Matrix44 mat_4, Matrix44 mat_5, Matrix44 mat_6)
{
	Matrix44 Temp;	Temp.Identity();
	Matrix44 mat[] = { mat_1 ,mat_2 ,mat_3 ,mat_4 ,mat_5 ,mat_6 };
	

	for (int i = 0; i < 6; i++) Temp = Temp.Multiply(mat[i]);

	/*
	Temp = Temp.Multiply(mat_1);
	Temp = Temp.Multiply(mat_2);
	Temp = Temp.Multiply(mat_3);
	Temp = Temp.Multiply(mat_4);
	Temp = Temp.Multiply(mat_5);
	Temp = Temp.Multiply(mat_6);
	*/
